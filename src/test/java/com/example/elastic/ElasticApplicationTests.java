...
class ElasticApplicationTests {
    ...
    void testCreateIndex() throws IOException {
        //1.创建索引的请求
        CreateIndexRequest request = new CreateIndexRequest("test5");
        //2客户端执行请求，请求后获得响应
...
//        添加文档-------CREATED
    ...
    void testExistDocument() throws IOException {
        //测试文档的 没有index
        GetRequest request= new GetRequest("test5","1");
        //没有indices()了
...
//        测试获取文档-----{"_index":"lisen_index","_type":"_doc","_id":"1","_version":1,"_seq_no":0,"_primary_term":1,"found":true,"_source":{"age":27,"name":"lisen"}}
    ...
    void testUpdateDocument() throws IOException {
        ...
        //修改是id为1的
        UpdateRequest request= new UpdateRequest("test5","1");
        request.timeout("1s");
...
//        测试获取文档-----{"_index":"lisen_index","_type":"_doc","_id":"1","found":false}
    ...
    void testDeleteDocument() throws IOException {
        DeleteRequest request= new DeleteRequest("test5","1");
        request.timeout("1s");
...
//        测试批量添加文档-----false
    ...
    void testSearchDocument() throws IOException {
        SearchRequest request = new SearchRequest("test5");
        //构建搜索条件
